...
[![CI pipeline - release](https://github.com/mattgmak/vscode-finditfaster/actions/workflows/ci.yml/badge.svg?branch=release)](https://github.com/mattgmak/vscode-finditfaster/actions?query=branch%3Amain)
...
- New command: `find-it-faster.findInActiveFile` to search lines in the active file. (no default key binding yet)
